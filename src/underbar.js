(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length-1] : array.slice( array[array.length-n-1], array[array.length-1]) ;
  };
  ...
  _.reject = function(collection, test) {
    ...
    return _.filter(collection, not);
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var firstItem = true;
    _.each(collection, function(value){
      if(typeof accumulator === 'undefined' && firstItem){
        accumulator = value;
        firstItem = false;
      } else {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(allPassed, item){
      return Boolean(allPassed && iterator(item));
    }, true);
  };
  ...
  _.some = function(collection, iterator) {
    //TODO: figure out how to re-use .every();
    if(iterator == null){
      iterator = _.identity;
    }
    return _.reduce(collection, function(somePassed, item){
      return Boolean(somePassed || iterator(item));
    }, false);
  };
  ...
  _.memoize = function(func) {
    ...
    return function(){
      ...
      var summery = temp.join("::");
        //TODO: replace long key strings with a proper hash.
  ...
  _.shuffle = function(array) {
    ...
    while(copy.length > 0) {
      ...
      result.push( copy.pop(randomIndex) );
    }
